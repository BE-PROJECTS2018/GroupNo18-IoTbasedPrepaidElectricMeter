    ...
    <script>
      anychart.onDocumentLoad(function () {
        // create an instance of a pie chart
            ...
            // set series data 
            data: [                         
              {x: "Domestic", value: 23.9}, 
              {x: "Commercial", value: 7.1},
              {x: "Industry", value: 34},   
              {x: "Traction", value: 2.6},  
              {x: "Agriculture", value: 29.2},
              {x:"Others",value: 4.9}     
            ],
            }],                            
...
<body>
	...
	<div class="container">
        ...
        <li class="active"><a href="analysis.php">2005-06</a></li>
        <li><a href="analysis2.php">2006-07</a></li>
        <li><a href="analysis3.php">2007-08</a></li>
